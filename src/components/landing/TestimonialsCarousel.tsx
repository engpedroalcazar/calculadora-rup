...
const TESTIMONIALS = [
  { role: "Engenheiro Civil e de Segurança do Trabalho", city: "Maringá/PR", initials: "PA", quote: "Uso o Obra Radar antes de aceitar qualquer contrato de obra maior. Em poucos minutos tenho clareza sobre a capacidade produtiva da equipe disponível e se o cronograma proposto é viável.", metric: "−18% em HH na frente revisada", serviceTag: "Engenharia diagnóstica" },
  { role: "Gerente de Planejamento", city: "Curitiba/PR", initials: "CT", quote: "Levei o laudo para a reunião de diretoria e usamos como base do replanejamento. O documento já trazia os indicadores com referência normativa, o que facilitou muito a aprovação da revisão de cronograma.", metric: "Replanejou 4 frentes em 2 semanas", serviceTag: "Residencial vertical" },
  { role: "Mestre de Obras", city: "Goiânia/GO", initials: "JR", quote: "Fui cético no início. Mas o relatório confirmou o que eu já observava no canteiro: o tempo perdido no transporte de material estava distorcendo a produção da frente de alvenaria.", metric: "Reorganizou logística da frente", serviceTag: "Alvenaria estrutural" },
  { role: "Coordenadora de Produção", city: "Recife/PE", initials: "RC", quote: "Antes levávamos três dias para fechar o controle de RUP de uma frente por mês. Com a plataforma, o levantamento sai no mesmo dia. Mudou o ritmo das nossas reuniões semanais de produção.", metric: "Economia de 3 dias/fechamento", serviceTag: "Industrial" },
  { role: "Diretor Técnico", city: "Belo Horizonte/MG", initials: "RA", quote: "Comprei o laudo sem muita expectativa, mas o detalhamento por fator — equipe, sequenciamento, ferramentas, supervisão — me deu argumento técnico para intervir em uma frente com desvio expressivo de produtividade.", metric: "R$ 92mil/mês de economia", serviceTag: "Infraestrutura" },
  { role: "Engenheiro de Obra", city: "Porto Alegre/RS", initials: "FB", quote: "Sou cético com plataformas digitais em geral. Mas a relação entre o custo do laudo e o nível de detalhamento entregue é difícil de questionar. Já usei em seis frentes distintas nos últimos meses.", metric: "6 laudos em 4 meses", serviceTag: "Comercial" },
  { role: "Engenheira de Segurança do Trabalho", city: "Florianópolis/SC", initials: "AF", quote: "Uso para cruzar com o PCMAT. Quando a RUP está fora de faixa, frequentemente há horas extras não formalizadas, o que gera exposição em fiscalizações do MTE. Já identifiquei duas situações assim antes de virarem problema.", metric: "Identificou risco trabalhista", serviceTag: "Segurança do trabalho" },
  { role: "Sócio-Gestor", city: "Salvador/BA", initials: "DP", quote: "Não esperava que fosse tão objetivo. Respondi as seis perguntas, identifiquei severidade crítica na fundação e tomei a decisão de redistribuir a equipe ainda naquela semana.", metric: "Recuperou 11 dias de cronograma", serviceTag: "Residencial horizontal" },
  { role: "Coordenadora de Obras", city: "Brasília/DF", initials: "ML", quote: "Em obra pública, cada hora-homem é auditável. Um laudo baseado em benchmarks normativos complementa o controle interno e oferece respaldo técnico adicional para as decisões de produção.", metric: "Adotado como padrão interno", serviceTag: "Obra pública" },
];
        ...
        >
          ...
          <div>
            ...
            <div style={{ marginTop: 32, display: "flex", alignItems: "center", gap: 32, flexWrap: "wrap" }}>
              <div>
                <div className="display" style={{ fontSize: 18, color: "#f3ecde" }}>{t.role}</div>
                <div style={{ marginTop: 6, fontSize: 12, color: "rgba(243,236,222,0.55)" }}>{t.city}</div>
              </div>
